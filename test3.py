...
if __name__ == '__main__':
    ...
    marker_list.append("markers=size:big|label:B|color:red|51.44346130003542, 0.08092060000362103|")  # tiny yellow B at lat/long
    ...
    get_static_google_map("google_map_example1", center="51.44346130003542, 0.08092060000362103", zoom=12, imgsize=(500, 500),
                          imgformat="jpg", maptype="terrain")

    get_static_google_map("/Users/ashleyrabbitts/Downloads/google_map_example2", center="51.44346130003542, 0.08092060000362103", zoom=18, imgsize=(500, 500),
                          maptype="hybrid")

    # make map that shows all the markers
    get_static_google_map("google_map_example3",center="51.44346130003542, 0.08092060000362103", imgsize=(640, 640),zoom=18, imgformat="png", markers=marker_list)
